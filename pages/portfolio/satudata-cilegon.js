...
const LandingPageSatudataCilegon = () => {
    ...
    <div>
      ...
      <Template menu='/portfolio'>
        ...
        <div className='text-center'>
          <Image 
            src='/assets/images/portfolio-putra/satudata-cilegon.png' 
            alt='Image'
            width={1000}
            height={500}
            objectFit='contain'/>
        ...
        <p className='mb-3 mt-10 text-justify'>
          Web portal untuk geospasial, opendata, dan Keuangan Kota Cilegon
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-3 divide-x mt-5 mb-10">
          <div className='p-3 px-5'>
            <p className='font-bold'>Access:</p>
            <a className='text-button1 underline' target='_blank' rel='noreferrer' href="https://satudata.cilegon.go.id/">
              Click here
            </a>
          </div>
          <div className='p-3 px-5'>
...
export default LandingPageSatudataCilegon